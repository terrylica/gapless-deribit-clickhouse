...
* add contract selection and spot integration (Phase 2) ([d1e4a1a](https://github.com/terrylica/gapless-deribit-clickhouse/commit/d1e4a1a2631c933c3e9ef1011802913fb8626a10))
...
- Database schema changed from deribit*options.trades
  to deribit.options_trades following {exchange}.{market}*{datatype} pattern.
...
- Dynamic **version** using importlib.metadata
